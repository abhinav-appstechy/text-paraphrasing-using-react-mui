...
import UserAvatar from "../assets/member_avatar.jpg";

const AboutUs = () => {
  return (
    <div className="font-[sans-serif] text-[#333] mt-20" id="about-us">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-x-8 gap-y-10 max-md:justify-center mt-12">
          {Array.from({ length: 6 }).map((item, idx)=>(
            <div className="border rounded-md overflow-hidden max-md:max-w-[300px]" key={idx}>
            <img src={UserAvatar} className="w-full h-60 object-contain object-top bg-gray-300" />
            <div className="p-4">
              <h4 className="text-base font-extrabold">John Doe</h4>
              <p className="text-xs mt-1">Software Engineer</p>
              <div className="mt-4">
                <p className="text-sm leading-relaxed">Eiusmod commodo aliquip laboris qui anim non voluptate consectetur.</p>
              </div>
